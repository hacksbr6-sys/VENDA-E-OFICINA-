          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (clientType === 'policial') taxPercent = 20;
                if (clientType === 'samu') taxPercent = 15;
      ...
      <div className="bg-black/50 rounded-xl p-6 border border-gray-800">
        ...
        {!isLoggedIn && (
          <p className="text-center text-gray-400 text-sm mt-2">
            Você precisa estar logado como administrador ou mecânico para gerar notas fiscais. 
            <Link to="/admin/login" className="text-red-400 hover:text-red-300 underline ml-1">
              Fazer login
            </Link>
          </p>
        )}
